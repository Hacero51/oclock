    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0a1229] text-gray-900">
      <div className="w-full max-w-md px-8 py-10 bg-[#CD0404] rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-semibold text-center text-white-900">
            En Punto.
          </h1>
        </div>
        ...
        <div className="text-center mb-6">
          <h2 className="text-xl font-bold text-white-900">Bienvenido</h2>
          <p className="text-sm text-white-500">Inicia sesión para continuar</p>
        </div>
        ...
        {/* Footer */}
        <p className="text-xs text-center text-white-400 mt-6">
